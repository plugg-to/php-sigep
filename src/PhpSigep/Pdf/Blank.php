...
class Blank
{
    ...
    private function _render ($dest='', $fileName= '')
    {
        ...
        while (count($objetosPostais)) {
            ...
            // $simbolo_de_encaminhamento = realpath(dirname(__FILE__)) . '/direct.png';
            ...
            if (!empty($observacoes)) {
                $this->pdf->SetFontSize(9);
                $this->pdf->SetXY(46.5, $currentY + 1);
                $this->multiLines(33, $observacoes, 'L', null);
            }
            // $this->pdf->SetFont('Helvetica','B',20);
            // $this->pdf->TextWithDirection(105,105,'CRJ001','U');
            ...
            // $this->setFillColor(222, 222, 222);
            // $this->pdf->gdImage($semaCodeGD, 43, 2, 25, 25);
    ...
    private function writeEndereco (
        ...
        if ($destinatario === true) {
            ...
            $this->pdf->SetFontSize(8);
            $this->pdf->SetXY(2, $t+1);
            $this->t($w, $titulo, 2, '');
            // Nome da pessoa
            $this->pdf->SetFont('', '', 8);
            $this->setFillColor(190, 190, 190);
            $this->pdf->SetXY(22, $t+1);
